...
const ProjectSec = () => {
  return (
    <div className='bg-zinc-800 text-4xl sm:text-5xl md:text-7xl flex flex-col font-extrabold p-8 sm:p-8 md:p-20 leading-normal sm:leading-relaxed gap-8 sm:gap-10 md:gap-15'>
      <div>
        <h1>crafted with <span className='text-pink-900'>love.</span></h1>
